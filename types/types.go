...
type Radio struct {
	...
	Frequency   float64 `json:"frequency" hcl:"frequency"`
	Gain        int     `json:"gain" hcl:"gain"`
	Name        string  `json:"name" hcl:"name"`
	DeviceIndex string  `json:"device_index" hcl:"device_index"`
	SampleRate  float64 `json:"sample_rate" hcl:"sample_rate"`
}
